    ...
    <MotionFlex  sx={{ width: '100%', maxWidth: 960, height: 'auto', flexDirection: 'column', alignItems: 'center', mt: [100, 150, 200, 150, 300]}} ref={ref}> 
      {showComponent &&
        ...
        >
            <MotionFlex 
              ...
              <MotionFlex>
                <MotionFlex 
                  ...
                  <MotionText variant='text.title-white' variants={titleContainer}>{t('label.fully').toUpperCase()}</MotionText>
                  <MotionText variant='text.title-bold-white' variants={titleContainer}>{t('label.functional').toUpperCase()}</MotionText>
                </MotionFlex>
              ...
              <MotionFlex sx={{ width: '100%', justifyContent: 'right', flexDirection: 'column', maxWidth: 645, mt: 80, fontSize: 64}}>
                <MotionFlex>
                  <MotionFlex sx={{ flexDirection: 'column'}}>
                    <MotionText variant='text.title-white' variants={titleContainer}>{t('label.fully').toUpperCase()}</MotionText>
                    <MotionText variant='text.title-bold-white' variants={titleContainer}>{t('label.permissionless').toUpperCase()}</MotionText>
                  </MotionFlex>
                  <MotionBox sx={{ width: 65, height: 65, position: 'relative'}} variants={logoContainer3}>        
            ...
            <MotionFlex
              variants={titlesContainer3}
              sx={{width:'100%', flexDirection: 'column', fontSize: 64, mt: 80}}>
              <MotionFlex>
                <MotionFlex sx={{ flexDirection: 'column'}}>
                  <MotionText as='text' variant='text.title-white' variants={titleContainer}>{t('label.fully').toUpperCase()}</MotionText>
                  <MotionText as='text' variant='text.title-bold-white' variants={titleContainer}>{t('label.open-source').toUpperCase()}</MotionText>
                </MotionFlex>
                <MotionBox sx={{ width: 65, height: 65, position: 'relative'}} variants={logoContainer3}>        
