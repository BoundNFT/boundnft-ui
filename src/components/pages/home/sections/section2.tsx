        ...
        <MotionFlex sx={{ width: '100%', flexDirection: 'column' }}>
          <MotionFlex variants={titlesContainer2} animate='visible' initial='hidden' sx={{ width: '100%', flexDirection: 'column' }}>
            <MotionText variant='text.title-white' variants={titleContainer}>
              {t('label.bound').toUpperCase()}
            </MotionText>
            <MotionText variant='text.title-bold-white' variants={titleContainer}>
              {t('label.any-kind-of-nfts').toUpperCase()}
            </MotionText>
            <MotionText variant='text.body' mt={16} variants={subTitleContainer}>
              {t('paragraph.section2-1').toUpperCase()}
            </MotionText>
          </MotionFlex>
          ...
          <MotionFlex sx={{ width: '100%', mt: 60, flexDirection: 'column' }}>
            ...
            >
              <Button text={t('button.get-started').toUpperCase()} backgroundColor='accent' onClick={() => router.push(permalink.collections)} />
