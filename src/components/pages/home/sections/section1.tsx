...
import {
  ...
  titleContainer,
  titlesContainer,
} from "./details/motion-containers";
  ...
  return (
    <MotionFlex sx={{ width: "100%", maxWidth: 1280, flexDirection: "column" }}>
      <MotionFlex
        ...
        animate="visible"
        initial="hidden"
        sx={{ width: "100%", flexDirection: "column", fontSize: "xxxl" }}
      >
      ...
      >
        <MotionBox
          ...
          animate="visible"
          initial="hidden"
          sx={{ width: 95, height: 75, position: "relative" }}
        >
          <Image src="/assets/images/boundnft_logo.svg" layout="fill" />
        </MotionBox>
        <MotionFlex
          variants={logoTextContainer}
          animate="visible"
          initial="hidden"
          sx={{ mt: 25 }}
        >
          <MotionText variant="text.semi-title-white">
