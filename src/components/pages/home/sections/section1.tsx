...
export const Section1 = () => {
  ...
  return (
    <MotionBox sx={{ width: '100%', maxWidth: 1280, flexDirection: 'column', position: 'relative', alignitems: 'center', px: [20, 20, 20, 40, null]}}>
      ...
      <MotionFlex sx={{position: 'relative', flexDirection: 'column', alignItems: 'center', ml: 25, mt: 40}} initial={{ opacity: 0 }} animate={{ opacity: 1}}>
      ...
      <MotionFlex sx={{ width: '100%', justifyContent: 'right', ml: [100, 100, 200, 450, 450], mt: [-250]}} initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
